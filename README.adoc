...
A lightweight CLI for comfortable command-line chat with LLMs. Thin wrapper around OpenAI-compatible APIs with tool calling, multimodal input, and MCP support.
